...
- Only set optional fields (topic, nsfw, slowmode) if the user explicitly asked for them.
...
<editing>
- Use edit_channel to modify name, topic, category, NSFW flag, slowmode, or position.
